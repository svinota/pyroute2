...
want to explicitly fix alignment, as if it were C struct,
...
`nla` class:
    ...
    - `target` -- a universal target (IPv4, IPv6, MPLS)
    - `l2addr` -- MAC address
...
explicit numbers (three fields tuples).
