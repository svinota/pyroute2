...
LinkModeBits = (
    ...
    LinkModeBit(
        bit_index=71, name='400000baseLR8_ER8_FR8/Full', type=LMBTypeMode
    ),
    ...
    LinkModeBit(bit_index=74, name='FEC_LLRS', type=LMBTypeOther),
    LinkModeBit(bit_index=75, name='100000baseKR/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=76, name='100000baseSR/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=77, name='100000baseLR_ER_FR/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=78, name='100000baseCR/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=79, name='100000baseDR/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=80, name='200000baseKR2/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=81, name='200000baseSR2/Full', type=LMBTypeMode),
    LinkModeBit(
        bit_index=82, name='200000baseLR2_ER2_FR2/Full', type=LMBTypeMode
    ),
    LinkModeBit(bit_index=83, name='200000baseDR2/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=84, name='200000baseCR2/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=85, name='400000baseKR4/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=86, name='400000baseSR4/Full', type=LMBTypeMode),
    LinkModeBit(
        bit_index=87, name='400000baseLR4_ER4_FR4/Full', type=LMBTypeMode
    ),
    LinkModeBit(bit_index=88, name='400000baseDR4/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=89, name='400000baseCR4/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=90, name='100baseFX/Half', type=LMBTypeMode),
    LinkModeBit(bit_index=91, name='100baseFX/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=92, name='10baseT1L/Full', type=LMBTypeMode),
    ...
    LinkModeBit(bit_index=98, name='800000baseVR8/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=99, name='10baseT1S/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=100, name='10baseT1S/Half', type=LMBTypeMode),
    LinkModeBit(bit_index=101, name='10baseT1S_P2MP/Half', type=LMBTypeMode),
    LinkModeBit(bit_index=102, name='10baseT1BRR/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=103, name='200000baseCR/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=104, name='200000baseKR/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=105, name='200000baseDR/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=106, name='200000baseDR_2/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=107, name='200000baseSR/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=108, name='200000baseVR/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=109, name='400000baseCR2/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=110, name='400000baseKR2/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=111, name='400000baseDR2/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=112, name='400000baseDR2_2/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=113, name='400000baseSR2/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=114, name='400000baseVR2/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=115, name='800000baseCR4/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=116, name='800000baseKR4/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=117, name='800000baseDR4/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=118, name='800000baseDR4_2/Full', type=LMBTypeMode),
    LinkModeBit(bit_index=119, name='800000baseSR4/Full', type=LMBTypeMode),
