...
import pyroute2.netlink.nl80211
...
#        print("attr={}".format(attr))
        if attr[0] == 'NL80211_ATTR_BSS':
            ...
            # NOTE: the contents of beacon and probe response frames may or may not contain all these fields.
            # Very likely there could be a keyerror in the following code. Needs a bit more bulletproofing.
            ...
            print("\tcapability: {}".format(bss['NL80211_BSS_CAPABILITY']['CAPABILITIES']))
            print("\tsignal: {0[VALUE]} {0[UNITS]}".format(bss['NL80211_BSS_SIGNAL_MBM']['SIGNAL_STRENGTH']))
